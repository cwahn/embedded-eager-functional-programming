...
// Negation
    ...
    namespace detail {
        ...
        struct FindIndexImpl<n, P, Head, Tail...> : Conditional<P<Head>::value, CtConst<size_t, n>, FindIndexImpl<n + 1, P, Tail...>> {};
    } // namespace detail
...
// Check the C++ standard version
    ...
    public:
        Tuple(const As&... as)
            : detail::TupleImpl<IndexSequenceFor<As...>, As...>{as...} {}
    ...
    namespace detail {
        ...
        template <typename F>
        struct ArgumentsImpl<F, Void<decltype(&F::operator())>> : ArgumentsImpl<decltype(&F::operator()), void> {};
